	...
	<?php endif; ?>
		...
		while ( $meteor_loop->have_posts() ) : $meteor_loop->the_post(); ?>
			...
			if ( $meteor_count == 1 && $meteor_loop->post_count > 1 ) {
				...
				echo '<img style="visibility: hidden;height: 300px!important;" class="meteor-shim" src="" alt="" />';
			...
			<div class="mslide mslide-<?php echo $meteor_count; ?>">
				...
				<?php // Adds slide image without Slide URL link
					...
					<?php 
						echo '<div
								style="background-image:url('. wp_get_attachment_image_src( get_post_thumbnail_id(), 'featured-slide')[0] .')"
								class="img"
								>
							</div>';						
					?>
